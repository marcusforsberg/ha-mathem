...
| Entity | Notes |
| --- | --- |
| `sensor.mathem_next_delivery` | Timestamp of the next window start. Attributes: `order_number`, `window` (Swedish text), `window_end`, `status`, `edit_deadline`, `address`, `doorstep_delivery`. |
