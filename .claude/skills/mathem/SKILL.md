...
| `sensor.mathem_last_delivery` | Timestamp of when the most recent order arrived. Use it to answer "has it been delivered yet" rather than inferring from the next-delivery sensor going empty. |
